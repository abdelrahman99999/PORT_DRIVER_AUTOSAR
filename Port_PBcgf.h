...
const Port_ConfigType Port_Configuration = {
        ...
        PORT_PORTF_ID, PORT_PIN1_ID, PORT_MODE_DIO, PORT_PIN_LEVEL_LOW , PORT_PIN_IN , PORT_RESISTOR_OFF, PORT_PIN_DIRECTION_UNCHANGEABLE , PORT_PIN_MODE_UNCHANGEABLE, 	
        ...
        PORT_PORTF_ID, PORT_PIN4_ID, PORT_MODE_DIO, PORT_PIN_LEVEL_LOW , PORT_PIN_IN , PORT_RESISTOR_OFF, PORT_PIN_DIRECTION_UNCHANGEABLE , PORT_PIN_MODE_UNCHANGEABLE
